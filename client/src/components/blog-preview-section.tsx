        ...
        {isLoading ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {Array.from({ length: 3 }).map((_, i) => (
              <motion.div
                key={i}
                className="backdrop-blur-md bg-slate-800/40 border border-slate-700/50 rounded-2xl shadow-xl animate-pulse overflow-hidden"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: i * 0.1 }}
                viewport={{ once: true }}
              >
                <div className="h-48 bg-gradient-to-br from-slate-700/50 to-slate-600/50 relative">
                  <div className="absolute top-4 right-4 w-8 h-8 bg-blue-500/20 rounded-full"></div>
                </div>
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="h-3 bg-gradient-to-r from-slate-600/50 to-slate-500/50 rounded w-1/3"></div>
                    <div className="h-3 bg-gradient-to-r from-slate-600/50 to-slate-500/50 rounded w-1/4"></div>
                  </div>
                  <div className="flex gap-2 mb-3">
                    <div className="h-5 bg-blue-500/20 rounded-lg w-16"></div>
                    <div className="h-5 bg-purple-500/20 rounded-lg w-20"></div>
                  </div>
                  <div className="h-6 bg-gradient-to-r from-slate-600/50 to-slate-500/50 rounded w-4/5 mb-3"></div>
                  ...
                  <div className="h-10 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg"></div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        >
          <Link href="/blog">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button size="lg" className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-10 py-4 rounded-xl shadow-lg hover:shadow-blue-500/25 transition-all duration-300">
